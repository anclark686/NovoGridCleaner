...
import re
from backend.helpers import is_dst, make_pretty_notes

desktop = os.path.join(os.path.join(os.path.expanduser("~")), "Desktop")
gm_path = f"{desktop}/GridMaster"

with open("backend/json_templates/grid_templates.json") as grid_templates_file:
...
def save_rsp_grid_details(row_list, dates, times, spoc):
    ...
    with open("backend/json_templates/rsp_grid_details.json", "w") as outfile:
