...
def get_json_data():
    # with open("backend/json_templates/project_details.json") as project_json:
    #     project_details = json.load(project_json)

    with open("backend/json_templates/rsp_grid_details.json") as rsp_grid_json:
        rsp_grid_data = json.load(rsp_grid_json)

    with open("backend/json_templates/rsp_pc_details.json") as rsp_pc_json:    
...
def save_combo_data(rsp_list, missing_rsp_list, overlaps, stats):
    ...
    with open("backend/json_templates/rsp_combo_details.json", "w") as outfile:
