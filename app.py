...
import json
from backend.squeaky_clean import folder_cleaner, clean_json
from backend.selenium_funcs import login
from backend.get_proj_details import find_master, project_details, recheck_dates
from backend.compare import adjust_confirmed_details
from backend.updater import gridmaster
from backend.emailer import grid_emailer
  
eel.init(f'{os.path.dirname(os.path.realpath(__file__))}/frontend/templates')  
